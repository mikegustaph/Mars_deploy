    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <ol class="breadcrumb bc-3">
                ...
                <li class="active"><strong>Yearly Report</strong></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="field-1" class="col-sm-3 control-label">Yearly Report</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control datepicker" name="site_name"
