            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ url('/update-client/' . $clients->id) }}" method="POST" role="form"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" value="{{ $clients->name }}"
                                                name="name" id="field-1" placeholder="Enter Company Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="field-1" class="col-sm-3 control-label">Company Address </label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" value="{{ $clients->address1 }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" value="{{ $clients->address2 }}"
                                                name="address2" id="field-1" placeholder="Enter Plot No, Block, House No">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="field-1" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" value="{{ $clients->city }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="tel" class="form-control" value="{{ $clients->phone_number }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="email" value="{{ $clients->email }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" value="{{ $clients->tin_number }}" class="form-control"
                                                name="tin_number" id="field-1" placeholder="00-00-00-00" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="vrn" id="field-1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="file" class="form-control" name="vrnCert" accept=".pdf"
                                                id="field-file" placeholder="Placeholder">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="efin" id="field-1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" value="{{ $clients->efinPassword }}"
                                                class="form-control" name="efinPassword" id="field-1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" value="{{ $clients->taxRegion }}" class="form-control"
                                                name="taxRegion" id="field-1" placeholder="Enter Region">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" value="{{ $clients->brelaOrs }}" class="form-control"
                                                name="brelaOrs" id="field-1" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="field-1" class="col-sm-4 control-label"> Cert of Reg Date Issued
                                        </label>
                                        <div class="col-sm-7">
                                            <input type="date" class="form-control" name="certRegDate"
                                                id="field-1">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="file" class="form-control" id="logo-img" name="images"
                                                accept=".jpg,.jpeg,.png" id="field-file" placeholder="Placeholder">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="field-1" class="col-sm-4 control-label"> Tax File Location </label>
                                        <div class="col-sm-7">
                                            <input type="file" class="form-control" name="taxFileLocation"
                                                id="field-file" placeholder="Placeholder">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" min="1900" max="2099" class="form-control "
                                                name="fiscalYear" id="field-1" placeholder="Enter year (e.g., 2023)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="year" class="form-control" name="companyType" id="field-1"
                                                placeholder="YYYY">
                                        </div>
                                    </div>
