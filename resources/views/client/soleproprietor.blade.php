                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="{{ url('/proprietor') }}" method="POST" role="form"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="number" id="numberInput" min="0"
                                                    max="999999999" class="form-control" name="tin_number"
                                                    id="field-1" placeholder="001******" required>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <input id="vrn" type="checkbox" onclick="toggleInputs()"
                                                    class="form-control" value="Yes" name="vrnAvailable"
                                                    id="field-file">
                                            </div>
                                        </div>
