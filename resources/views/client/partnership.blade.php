                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <button onclick="jQuery('#modal-1').modal('show')" type="submit" id="submit-btn"
                            ...
                            Company Formation<i class="entypo-user-add"></i>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            <form action="{{ route('client.partnership') }}" method="POST" role="form"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="number" min="0" max="999999999"
                                                    class="form-control" name="tin_number" id="tinumber"
                                                    data-mask="*** *** ***" placeholder="000-000-000" required>
                                            </div>
                                        </div>
                                        <script>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <input type="file" class="form-control" name="tinCert"
                                                    accept=".pdf" id="field-file" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-7">
                                                <input type="hidden" class="form-control" name="compType"
                                                    value="{{ $comp }}" id="field-file" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="file" class="form-control" name="certReg"
                                                    accept=".pdf" id="field-file" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="field-1" class="col-sm-4 control-label"> Certificate of
                                                Extract</label>
                                            <div class="col-sm-7">
                                                <input type="file" class="form-control" name="certExtr"
                                                    accept=".pdf" id="field-file" required>
                                            </div>
                                        </div>
                                        <div class="form-group" id="vrnAttach">
