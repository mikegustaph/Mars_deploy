                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->tra_portal_name }}" name="tra_portal_name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->tra_portal_tin }}" name="tra_portal_tin"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->tax_portal_passwrd }}"
                                                    name="tax_portal_passwrd" id="field-1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->tax_portal_tin }}" name="tax_portal_tin"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->payment_passwrd }}" name="payment_passwrd"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->brela_name }}" name="brela_name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->brela_userid }}" name="brela_userid"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->brela_passwrd }}" name="brela_passwrd"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->nssf_userid }}" name="nssf_userid"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->nssf_passwrd }}" name="nssf_passwrd"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->efin_userid }}" name="efin_userid"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->efin_passwrd }}" name="efin_passwrd"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->wcf_userid }}" name="wcf_userid"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->wcf_passwrd }}" name="wcf_passwrd"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->wcf_ic_name }}" name="wcf_ic_name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->wcf_ic_userid }}" name="wcf_ic_userid"
                                                    id="field-1" placeholder="Enter wcf name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control"
                                                    value="{{ $pwdupdate->bo_name }}" name="bo_name" id="field-1"
