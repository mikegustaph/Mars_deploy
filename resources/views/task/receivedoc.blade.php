                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            <form method="POST" action="{{ route('task.storeDoc') }}" role="form"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="field-3" class="col-sm-3 text-right control-label">Task
                                                No:</label>
                                            <div class="col-sm-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="field-3"
                                                class="col-sm-3 text-right control-label">Client</label>
                                            <div class="col-sm-8">
                                                <select name="client" class="selectboxit" readyonly>
                                                    <option value="{{ $task->client->id }}">{{ $task->client->name }}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="field-3"
                                                class="col-sm-2 text-right control-label">Service</label>
                                            <div class="col-sm-5">
                                                <select name="service" class="selectboxit" readyonly>
                                                    <option value="{{ $task->client->clientserv->serv->id }}">
                                                        {{ $task->client->clientserv->serv->service_name }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <input type="date" name="dateReceived" class="form-control col-sm-2"
                                            id="field-2" placeholder="dd/mm/yyyy" required>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" name="note" class="form-control col-sm-2"
                                            id="field-2" placeholder="Note">
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="number" name="quantity" class="form-control" id="field-2"
