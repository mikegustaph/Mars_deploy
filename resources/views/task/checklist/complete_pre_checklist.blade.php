<div class="col-md-6">
    <table class="table table-bordered">
            ...
            @foreach ($precheck as $key => $value)
                <tr>
                    <td style="display: none;">
                        <input type="text" class="form-control" name="task_id" value="{{ $mainTask->id }}" id="field-file"
                            placeholder="">
                    </td>
                    <td style="display: none;">
                    ...
                    <td>
                        ...
                        <input type="file" class="form-control" name="precheck_attach[]" accept=".pdf"
                            id="field-file" placeholder="" disabled>
        ...
        <tfoot>
            ...
            <td></td>
            <td>
                <button disabled id="progress-btn" type="submit" style="float:right;" class="btn btn-success">
                    Confirm
                </button>
            </td>
    </table>
