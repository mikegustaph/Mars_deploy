...
<head>
    ...
    <title>{{ isset($title) ? $title : 'Default Title' }} | Dashboard</title>
            ...
            <div class="row">
                <div class="col-sm-3 col-xs-6">
                    <div class="tile-stats tile-red">
                        ...
                        <div class="num" data-start="0" data-end="{{ $totalEmployees }}" data-postfix=""
                            data-duration="1500" data-delay="0">0</div>

                        <h3> Employees</h3>
                        <p>So far in the system</p>
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6">
                    <div class="tile-stats tile-green">
                        <div class="icon"><i class="entypo-chart-bar"></i></div>
                        <div class="num" data-start="0" data-end="{{ $totalTask }}" data-postfix=""
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="tile-stats tile-blue">
                        ...
                        <div class="num" data-start="0" data-end="{{ $totalClients }}" data-postfix=""
